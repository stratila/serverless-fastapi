...
resource "aws_api_gateway_integraion_response" "api_integration_response" {
...
resource "aws_api_gateway_method_response" "aws_api_gateway_method_response" {
  ...
  rest_api_id = aws_api_gateway_response.api_response[each.key].rest_api_id
  resource_id = aws_api_gateway_response.api_response[each.key].resource_id
  http_method = each.value.method
...
resource "aws_api_gateway_deployment" "api_deployment" {
  ...
  depends_on = [
    ...
    aws_api_gateway_integraion_response.api_integration_response,
